!(function(e, t) {
	...
	function b(e) {
		return null == e
			? e + ''
			: 'object' == typeof e || 'function' == typeof e ? c[u.call(e)] || 'object' : typeof e;
	}
	var x = '3.4.0',
		w = function(e, t) {
			...
			if (!i && ((t ? t.ownerDocument || t : w) !== d && p(t), (t = t || d), g)) {
				...
				if (n.qsa && !k[e + ' '] && (!m || !m.test(e)) && (1 !== T || 'object' !== t.nodeName.toLowerCase())) {
					if (((v = e), (y = t), 1 === T && _.test(e))) {
						for (
							(u = t.getAttribute('id')) ? (u = u.replace(re, ie)) : t.setAttribute('id', (u = x)),
								a = (h = s(e)).length;
							a--;
								...
								return (
									...
									(!n.sortDetached && t.compareDocumentPosition(e) === r)
										? e === d || (e.ownerDocument === w && b(w, e))
											? -1
											: t === d || (t.ownerDocument === w && b(w, t)) ? 1 : u ? R(u, e) - R(u, t) : 0
										: 4 & r ? -1 : 1)
								);
							}
						: function(e, t) {
								...
								var n,
									...
									a = [ t ];
								if (!i || !o)
									return e === d ? -1 : t === d ? 1 : i ? -1 : o ? 1 : u ? R(u, e) - R(u, t) : 0;
									...
									if (((h = [ s ? m.firstChild : m.lastChild ]), s && y)) {
										...
										for (
											...
											((a ? p.nodeName.toLowerCase() !== v : 1 !== p.nodeType) ||
												!++b ||
												(y &&
													((u = (f = p[x] || (p[x] = {}))[p.uniqueID] || (f[p.uniqueID] = {}))[
														e
													] = [ T, b ]),
												p !== t));
				...
				: function(t, n, l) {
						...
						if (l) {
							...
							for (; (t = t[r]); )
								if (1 === t.nodeType || s)
									if (
										((u = (f = t[x] || (t[x] = {}))[t.uniqueID] || (f[t.uniqueID] = {})),
				...
				ce(function(o, s, a, l) {
					...
					if (o) {
						if (i || e) {
							...
							for (u = v.length; u--; )
								(f = v[u]) && -1 < (c = i ? R(o, f) : p[u]) && (o[c] = !(s[c] = f));
						}
		...
		return (
			...
			(s = ae.tokenize = function(e, t) {
				...
				for (a = e, l = [], c = r.preFilter; a; ) {
					...
					(n = !1),
					(i = $.exec(a)) &&
						((n = i.shift()), o.push({ value: n, type: i[0].replace(B, ' ') }), (a = a.slice(n.length))),
					r.filter))
						!(i = V[s].exec(a)) ||
							(c[s] && !(i = c[s](i))) ||
			...
			(l = ae.select = function(e, t, n, i) {
				...
				if (((n = n || []), 1 === d.length)) {
					...
					for (o = V.needsContext.test(e) ? 0 : l.length; o-- && ((c = l[o]), !r.relative[(u = c.type)]); )
						if (
							(f = r.find[u]) &&
							(i = f(c.matches[0].replace(te, ne), (ee.test(l[0].type) && ve(t.parentNode)) || t))
						) {
	...
	((w.fn.init = function(e, t, n) {
		...
		if (((n = n || H), 'string' == typeof e)) {
			if (
				!(i = '<' === e[0] && '>' === e[e.length - 1] && 3 <= e.length ? [ null, e, null ] : j.exec(e)) ||
				(!i[1] && t)
			)
	...
	w.fn.extend({
		...
		index: function(e) {
			return e
				? 'string' == typeof e ? l.call(w(e), this[0]) : l.call(this, e.jquery ? e[0] : e)
			...
			function(e, t) {
				w.fn[e] = function(n, r) {
					...
					return (
						...
						1 < this.length && (O[e] || w.uniqueSort(i), W.test(e) && i.reverse()),
						this.pushStack(i)
					);
				};
			}
	...
	(w.Callbacks = function(e) {
		...
		w.extend({
			...
			when: function(e) {
				...
				if (
					t <= 1 &&
					(Y(e, s.done(a(n)).resolve, s.reject, !t), 'pending' === s.state() || g(i[n] && i[n].then))
				)
					return s.then();
	...
	var F = function(e, t, n, r, i, o, s) {
			var a = 0,
				l = e.length,
				c = null == n;
			if ('object' === b(n)) for (a in ((i = !0), n)) F(e, t, a, n[a], !0, o, s);
			else if (
				void 0 !== r &&
				((i = !0),
				g(r) || (s = !0),
				...
				return 'object' == typeof e
					...
					: F(
							...
							function(t) {
								var n;
								if (o && void 0 === t)
									return void 0 !== (n = Q.get(o, e)) ? n : void 0 !== (n = ee(o, e)) ? n : void 0;
								this.each(function() {
									Q.set(this, e, t);
								});
							},
	...
	function ce(e, t, n, r) {
		...
		if (u && u[3] !== c) {
			for (l /= 2, c = c || u[3], u = +l || 1; s--; )
				w.style(e, t, u + c), (1 - o) * (1 - (o = a() / l || 0.5)) <= 0 && (s = 0), (u /= o);
	...
	function fe(e, t) {
		for (var n, r, i, o, s, a, l, c = [], u = 0, f = e.length; u < f; u++)
			(r = e[u]).style &&
				((n = r.style.display),
				t
					? ('none' === n && ((c[u] = G.get(r, 'display') || null), c[u] || (r.style.display = '')),
						'' === r.style.display &&
							ae(r) &&
							(c[u] = ((l = s = o = void 0),
							(s = (i = r).ownerDocument),
					...
					handler: function(e) {
						...
						if (1 & e.isTrigger && this[t]) {
							if (s) (w.event.special[t] || {}).delegateType && e.stopPropagation();
								...
								(r = n(this, t)),
								this[t](),
								s !== (i = G.get(this, t)) || r ? G.set(this, t, !1) : (i = void 0),
								s !== i)
							)
								return e.stopImmediatePropagation(), e.preventDefault(), i;
						} else
							s &&
								(G.set(this, t, w.event.trigger(w.extend(s.shift(), w.Event.prototype), s, this)),
			...
			if (m && (l = m.events)) {
				for (c = (t = (t || '').match(M) || [ '' ]).length; c--; )
					if (((d = g = (a = Ce.exec(t[c]) || [])[1]), (h = (a[2] || '').split('.').sort()), d)) {
						...
						s &&
							!p.length &&
							((f.teardown && !1 !== f.teardown.call(e, h, m.handle)) || w.removeEvent(e, d, m.handle),
							delete l[d]);
				...
				for (s = w.event.handlers.call(this, a, c), t = 0; (i = s[t++]) && !a.isPropagationStopped(); )
					for (a.currentTarget = i.elem, n = 0; (o = i.handlers[n++]) && !a.isImmediatePropagationStopped(); )
						(a.rnamespace && !1 !== o.namespace && !a.rnamespace.test(o.namespace)) ||
							...
							(a.data = o.data),
							void 0 !==
								(r = ((w.event.special[o.origType] || {}).handle || o.handler).apply(i.elem, l)) &&
								!1 === (a.result = r) &&
		...
		special: {
			...
			click: {
				...
				trigger: function(e) {
					var t = this || e;
					return (
						pe.test(t.type) && t.click && A(t, 'input') && void 0 === G.get(t, 'click') && De(t, 'click'),
						!0
					);
				},
				_default: function(e) {
			...
			e && e.type
				? ((this.originalEvent = e),
					...
					(this.isDefaultPrevented =
						e.defaultPrevented || (void 0 === e.defaultPrevented && !1 === e.returnValue) ? Se : Le),
					...
					(c = a[f]),
						he.test(c.type || '') &&
							...
							(c.src && 'module' !== (c.type || '').toLowerCase()
								? w._evalUrl &&
									!c.noModule &&
									w._evalUrl(c.src, { nonce: c.nonce || c.getAttribute('nonce') })
	...
	function Ye(e, t, n) {
		for (var r, i = t ? w.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
			n || 1 !== r.nodeType || w.cleanData(me(r)),
				r.parentNode && (n && oe(r) && ve(me(r, 'script')), r.parentNode.removeChild(r));
		return e;
	}
	w.extend({
		...
		clone: function(e, t, n) {
			...
			if (!(h.noCloneChecked || (1 !== e.nodeType && 11 !== e.nodeType) || w.isXMLDoc(e)))
				for (s = me(u), r = 0, i = (o = me(e)).length; r < i; r++)
					(a = o[r]),
						'input' === (c = (l = s[r]).nodeName.toLowerCase()) && pe.test(a.type)
							? (l.checked = a.checked)
							: ('input' !== c && 'textarea' !== c) || (l.defaultValue = a.defaultValue);
			if (t)
				if (n) for (o = o || me(e), s = s || me(u), r = 0, i = o.length; r < i; r++) Pe(o[r], s[r]);
				else Pe(e, u);
			...
			'margin' === n && (l += w.css(e, n + re[s], !0, i)),
				r
					? ('content' === n && (l -= w.css(e, 'padding' + re[s], !0, i)),
						'margin' !== n && (l -= w.css(e, 'border' + re[s] + 'Width', !0, i)))
		...
		style: function(e, t, n, r) {
			if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
				var i,
					...
					l = Ge.test(t),
					c = e.style;
				if ((l || (t = Ve(a)), (s = w.cssHooks[t] || w.cssHooks[a]), void 0 === n))
					return s && 'get' in s && void 0 !== (i = s.get(e, !1, r)) ? i : c[t];
				'string' == (o = typeof n) && (i = ne.exec(n)) && i[1] && ((n = ce(e, t, i)), (o = 'number')),
					null != n &&
						n == n &&
		...
		((nt.propHooks = {
			_default: {
				...
				set: function(e) {
					w.fx.step[e.prop]
						? w.fx.step[e.prop](e)
						: 1 !== e.elem.nodeType || (!w.cssHooks[e.prop] && null == e.elem.style[Ve(e.prop)])
							? (e.elem[e.prop] = e.now)
		...
		var r,
			...
			c = a.promise({
				...
				stop: function(t) {
					...
					return (
						t ? (a.notifyWith(e, [ c, 1, 0 ]), a.resolveWith(e, [ c, t ])) : a.rejectWith(e, [ c, t ]), this
					);
				}
			}),
			u = c.props;
				...
				if ((l = !w.isEmptyObject(t)) || !w.isEmptyObject(d))
					for (r in (f &&
						...
						'none' === (u = w.css(e, 'display')) &&
							(c
								? (u = c)
								: (fe([ e ], !0), (c = e.style.display || c), (u = w.css(e, 'display')), fe([ e ]))),
			...
			attr: function(e, t, n) {
				...
				if (3 !== o && 8 !== o && 2 !== o)
					return void 0 === e.getAttribute
						? w.prop(e, t, n)
						: ((1 === o && w.isXMLDoc(e)) ||
								(i = w.attrHooks[t.toLowerCase()] || (w.expr.match.bool.test(t) ? ht : void 0)),
							void 0 !== n
								? null === n
			...
			return arguments.length
				...
				: i
					? (t = w.valHooks[i.type] || w.valHooks[i.nodeName.toLowerCase()]) &&
						...
						? n
						: 'string' == typeof (n = i.value) ? n.replace(wt, '') : null == n ? '' : n
					: void 0;
		}
	}),
		w.extend({
				...
				for (s = 0; (a = v[s++]) && !t.isPropagationStopped(); )
					(h = a),
						...
						(p = u && a[u]) &&
							p.apply &&
							V(a) &&
							((t.result = p.apply(a, n)), !1 === t.result && t.preventDefault());
				return (
					(t.type = y),
					o ||
			...
			ajax: function(t, n) {
				...
				h.hasContent
					...
					: ((d = h.url.slice(o.length)),
						...
						!1 === h.cache && ((o = o.replace(Ot, '$1')), (d = (Lt.test(o) ? '&' : '?') + '_=' + St++ + d)),
						(h.url = o + d)),
				h.ifModified &&
				...
				function S(t, n, r, a) {
					...
					u ||
						...
						c
							? (h.ifModified &&
									((T = C.getResponseHeader('Last-Modified')) && (w.lastModified[o] = T),
	...
	(h.cors = !!Ut && 'withCredentials' in Ut),
		...
		w.ajaxTransport('script', function(e) {
			...
			if (e.crossDomain || e.scriptAttrs)
				return {
					send: function(i, o) {
						(t = w('<script>').attr(e.scriptAttrs || {}).prop({ charset: e.scriptCharset, src: e.url }).on(
							'load error',
							(n = function(e) {
	...
	w.ajaxSetup({
			...
			if (a || 'jsonp' === t.dataTypes[0])
				return (
					...
					a
						...
						: !1 !== t.jsonp && (t.url += (Lt.test(t.url) ? '&' : '?') + t.jsonp + '=' + i),
		...
		(h.createHTMLDocument = (((zt = r.implementation.createHTMLDocument('').body).innerHTML =
			'<form></form><form></form>'),
						...
						function(t, n, i) {
							...
							return m(t)
								...
								: 9 === t.nodeType
									...
									: void 0 === i ? w.css(t, n, a) : w.style(t, n, i, a);
						},
						t,
						s ? i : void 0,
						s
	...
	(function(e, t) {
		...
		function o(e) {
			...
			for (var n = i(10) ? document.body : null, r = e.offsetParent || null; r === n && e.nextElementSibling; )
				r = (e = e.nextElementSibling).offsetParent;
			var s = r && r.nodeName;
			return s && 'BODY' !== s && 'HTML' !== s
				? -1 !== [ 'TH', 'TD', 'TABLE' ].indexOf(r.nodeName) && 'static' === t(r, 'position') ? o(r) : r
		...
		function g(e, n) {
			...
			var v = d({ top: l.top - u.top - g, left: l.left - u.left - m, width: l.width, height: l.height });
		...
		function m(e) {
			var t = 1 < arguments.length && void 0 !== arguments[1] && arguments[1],
				...
				s = t ? 0 : l(n),
				a = t ? 0 : l(n, 'left');
			return d({ top: s - r.top + r.marginTop, left: a - r.left + r.marginLeft, width: i, height: o });
		}
		function v(e) {
			var r = e.nodeName;
		...
		function b(e, t, i, o) {
			...
			if ('viewport' === o) l = m(c, s);
				...
				var u;
				'scrollParent' === o
					? 'BODY' === (u = r(n(t))).nodeName && (u = e.ownerDocument.documentElement)
		...
		function H(e, t, n, i) {
			...
			return (
				(function e(t, n, i, o) {
					...
					a.addEventListener(n, i, { passive: !0 }), s || e(r(a.parentNode), n, i, o), o.push(a);
					...
					return e
						.reduce(function(e, t) {
							return '' === e[e.length - 1] && -1 !== [ '+', '-' ].indexOf(t)
								...
								: s ? ((e[e.length - 1] += t), (s = !1), e) : e.concat(t);
						}, [])
						.map(function(e) {
			...
			oe = (function() {
				function t(n, r) {
					...
					K(this, t),
						...
						Object.keys(J({}, t.Defaults.modifiers, o.modifiers)).forEach(function(e) {
						...
						fn: function(e) {
							...
							if (r) {
								var i = e.offsets,
									...
									l = a ? 'left' : 'top',
									c = a ? 'width' : 'height',
									u = { start: Q({}, l, o[l]), end: Q({}, l, o[l] + o[c] - s[c]) };
							...
							var u = t.priority,
								...
								p = {
									primary: function(e) {
										var n = f[e];
										return (
											f[e] < c[e] && !t.escapeWithReference && (n = I(f[e], c[e])), Q({}, e, n)
										);
									},
									secondary: function(e) {
										...
										return (
											f[e] > c[e] &&
												...
												(r = q(f[n], c[e] - ('right' === e ? f.width : f.height))),
											Q({}, n, r)
										);
									}
								};
					...
					computeStyle: {
						...
						fn: function(e, t) {
							...
							if (
								((l =
									'bottom' == g
										? 'HTML' === u.nodeName ? -u.clientHeight + d.bottom : -f.height + d.bottom
										: d.top),
								(a =
									'right' == m
										? 'HTML' === u.nodeName ? -u.clientWidth + d.right : -f.width + d.right
										: d.left),
								c && v)
							)
	...
	(function(e, t) {
		'object' == typeof exports && 'undefined' != typeof module
			? (module.exports = t())
			: 'function' == typeof define && define.amd ? define(t) : (e.PerfectScrollbar = t());
	})(this, function() {
		'use strict';
		function e(e) {
				...
				!(function(e, t, n, r, i) {
					...
					(e.reach[u] = null),
						...
						t &&
							...
							r && l(e, u)),
						e.reach[u] && (t || i) && d.dispatchEvent(c('ps-' + u + '-reach-' + e.reach[u]));
				})(e, n, o, r, i);
			},
			T = {
			...
			C = {
				...
				wheel: function(t) {
					function n(t, n, r) {
						...
						for (var o = t; o && o !== i; ) {
							...
							if ([ s.overflow, s.overflowX, s.overflowY ].join('').match(/(scroll|auto)/)) {
								...
								if (l > 0 && !((0 === o.scrollLeft && n < 0) || (o.scrollLeft === l && n > 0)))
									return !0;
							}
							o = o.parentNode;
						}
					...
					void 0 !== window.onwheel
						...
						: void 0 !== window.onmousewheel && t.event.bind(i, 'mousewheel', r);
				},
				touch: function(t) {
					function n(e, n) {
						var r = Math.floor(u.scrollTop),
							...
							s = Math.abs(n);
						if (s > o) {
							if ((n < 0 && r === t.contentHeight - t.containerHeight) || (n > 0 && 0 === r))
								return 0 === window.scrollY && n > 0 && T.isChrome;
						} else if (o > s && ((e < 0 && i === t.contentWidth - t.containerWidth) || (e > 0 && 0 === i)))
							return !0;
						return !0;
					}
					function r(e, n) {
					...
					function a(t, n, r) {
						...
						for (var i = t; i && i !== u; ) {
							...
							if ([ o.overflow, o.overflowX, o.overflowY ].join('').match(/(scroll|auto)/)) {
								...
								if (a > 0 && !((0 === i.scrollLeft && n < 0) || (i.scrollLeft === a && n > 0)))
									return !0;
							}
							i = i.parentNode;
						}
			...
			S = function(r, i) {
				...
				(this.scrollbarYRight = parseInt(f.right, 10)),
					isNaN(this.scrollbarYRight)
						? ((this.isScrollbarYUsingRight = !1), (this.scrollbarYLeft = u(f.left)))
					...
					(this.scrollbarYOuterWidth = this.isRtl
						...
						: null),
					(this.railBorderYWidth = u(f.borderTopWidth) + u(f.borderBottomWidth)),
					...
					(this.reach = {
						x:
							r.scrollLeft <= 0
								? 'start'
								: r.scrollLeft >= this.contentWidth - this.containerWidth ? 'end' : null,
						y:
							r.scrollTop <= 0
								? 'start'
								: r.scrollTop >= this.contentHeight - this.containerHeight ? 'end' : null
					}),
					(this.isAlive = !0),
